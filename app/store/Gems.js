Ext.define('Bejeweled.store.Gems', {
	...
	data: [
		...
		{ color0: 'blue', color1: 'white', color2: 'orange', color3: 'white', color4: 'orange', color5: 'red', color6: 'green', color7: 'red' },
		{ color0: 'orange', color1: 'white', color2: 'blue', color3: 'red', color4: 'white', color5: 'green', color6: 'blue', color7: 'green' },
		{ color0: 'white', color1: 'blue', color2: 'red', color3: 'blue', color4: 'green', color5: 'white', color6: 'red', color7: 'red' },
		{ color0: 'green', color1: 'white', color2: 'white', color3: 'orange', color4: 'red', color5: 'green', color6: 'blue', color7: 'white' },
